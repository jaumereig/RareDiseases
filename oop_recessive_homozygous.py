...
class DataProcessor:
    ...
    def process_data(self):
        ...
        for idx, row in self.samples[0].data.iterrows():
            af_values = ['0.5'] * len(self.samples)
        ...
        # df_final.to_csv(self.output_dir + "rechom." + self.fam + ".tsv", sep="\t", header=True, index=False)
...
if __name__ == '__main__':
    ...
    output_dir = "/home/vant/Escritorio/pid/"+"argentina_yam"+"/oop/"
    fam = "arg"
